  ...
  <br>
    ...
    <div class="tabla-general" >
        ...
        <thead class="table table-striped table-bordered text-white" style="background:rgb(2, 117, 216); color: aliceblue">
            <tr>
            <th class="column4 text-center" >Estado</th>
            <th class="column1 text-center">Sucursal Origen</th>
            <th class="column2 text-center">Almacen</th>
            <th class="column3 text-center">Sucursal Destino</th>
        ...
        <tbody class="table-bordered" id="myTable"> 
            ...
            <tr>
                ...
                @else
                    <td class="text-center" style="background: #29c900" ><b>{{$transferencia->estado}}</b></td>
                @endif
                
                <td class="text-center" >{{$transferencia->id_origen}}</td>
                <td class="text-center" >{{$transferencia->id_almacen}}</td>
                <td class="text-center" >{{$transferencia->id_destino}}</td>
                <td class="text-center" >{{$transferencia->created_at}}</td>
                ...
                @endcan
                  ...
                  {{-- ELIMINAR --}}
                  <div class="modal fade" id="eliminar{{$transferencia->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
