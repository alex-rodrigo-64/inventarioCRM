...
@section('content')
<h1 align="center" style="font-weight: 700">LISTA DE PROVEEDORES </h1>
  ...
  <br>
    ...
    <div class="tabla-general" >
        ...
        <thead class="table table-striped table-bordered text-white" style="background:rgb(2, 117, 216); color: aliceblue">
            ...
            <th class="column2 text-center">Nombre de Proveedor</th>
        ...
        <tbody class="table-bordered" id="myTable"> 
            ...
            <tr>
                <td class="text-center" >{{$proveedors->id}}</td>
                <td class="text-center" >{{$proveedors->nombre_proveedor}}</td>
                <td class="text-center" >{{$proveedors->direccion_proveedor}}</td>
                <td class="text-center" >{{ \Carbon\Carbon::parse($proveedors->created_at)->format('d-m-Y')}}</td>
                ...
                @can('editar proveedors')
                     {{-- EDITAR --}}
                <a href="{{ url('/proveedor/editar/'.$proveedors->id)}}">
                ...
                @can('borrar proveedors')
                  {{-- ELIMINAR --}}
                  <button class="btn d-inline" style="color: red"  data-toggle="modal" data-target="#eliminar{{$proveedors->id}}">
                ...
                @endcan
                  ...
                  {{-- ELIMINAR --}}
                  <div class="modal fade" id="eliminar{{$proveedors->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title w-100 text-center" id="exampleModalLabel">Eliminar Proveedor</h5>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
                        <div class="modal-body">
                         ¿Realmente Desea Borrar el Proveedor?
                        </div>
