...
@section('content')
<h1 align="center" style="font-weight: 700">EDITAR PROVEEDOR </h1>
        ...
        <div class="card-body">
            <form action="{{url('/proveedor/nuevo')}}" id="formulario" method="POST">
              ...
              <div class="card">
                    ...
                    <div class="row">
                      <div class="col-6">
                        <div class="input-group">
                          <span class="input-group-text"  style=" background:rgb(29, 145, 195); color: aliceblue"><span style="color: red">*</span>Direccion</span>
                             <input type="text" id="direccion" name="direccion" class="form-control" placeholder="Nueva Direccion" value="{{ $proveedor->direccion_proveedor}}"
                      ...
                      <div class="col-6">
                        <div class="input-group">
                            ...
                            <input type="text" name="celular" id="celular" required value="{{ $proveedor->celular}}" class="form-control" placeholder="Numero Celular" tabindex="1" onkeypress="return ((event.charCode >= 48 && event.charCode <= 57)) ">               
                        </div>
                        <span id="estadoRol"></span>
                    </div>
                    </div>
                ...
                <textarea class="embed-responsive form-control " style="resize: none;padding-left: 20px;padding-top: 20px" name="detalle" id="detalle" cols="140" rows="4">
                {{$proveedor->detalle}}
                </textarea>
                <br> 
