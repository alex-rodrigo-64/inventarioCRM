...
@section('content')
<h1 align="center" style="font-weight: 700">EDITAR INVENTARIO</h1>
              ...
              <div class="card">
                  <div class="card-body">
                        ...
                        <div class="col-4">
                            <div class="input-group">
                              ...
                              <select name="sucursal" required id="sucursal" onchange="getAlmacen()" class="form-control">
                                ...
                                @if ($inventario->id_sucursal == $sucursales->id)
                                <option   value="{{$sucursales->id}}" selected> {{$sucursales->nombre_sucursal}}</option>
                                @else
                        ...
                        <div class="col-4">
                            <div class="input-group">
                              ...
                              <select name="almacen" required id="almacen" class="form-control">
                                ...
                                @if ($inventario->id_almacen == $almacen->id)
                                <option   value="{{$almacen->id}}" selected> {{$almacen->nombre_almacen}}</option>
                                @else
                    ...
                    <div class="row">
                      <div class="col-3">
                            <div class="input-group">
                              ...
                              <input type="text" name="codigo" id="codigo" required value="{{ $inventario->codigo }}" class="form-control" onkeyup="validarNombre()" placeholder="#" tabindex="1" >
                            </div>
                          <span id="estadoNombre"></span>
                        </div>
                    </div>
                          ...
                          <div class="input-group">
                            ...
                            <select name="proveedor" required id="proveedor" class="form-control">
                              <option disabled value="" selected>Seleccione un Proveedor</option>
                                ...
                                @if ($inventario->proveedor == $proveedor->nombre_proveedor)
                      ...
                      <div class="col-5">
                        <div class="input-group">
                          <span class="input-group-text"  style=" background:rgb(29, 145, 195); color: aliceblue">Cantidad</span>
                            <input type="text" id="cantidad" name="cantidad" class="form-control text-center" value="{{$inventario->cantidad}}"
                        required   onkeypress="return ((event.charCode >= 48 && event.charCode <= 57))">
                          <select name="cantidadP" required id="cantidadP" class="form-control">
                            <option disabled value="" selected>Seleccione una Unidad</option>
                                ...
                                @if ($inventario->unidad == $unidad->nombre_unidad)
                                <option   value="{{$unidad->nombre_unidad}}" selected> {{$unidad->nombre_unidad}}</option>
                                @else
                    ...
                    <div class="col-3">
                      ...
                      <input type="text" id="cantidadUnitaria" name="cantidadUnitaria" class="form-control text-center" value="{{$inventario->cantidad_unitaria}}"
                    ...
                    <div class="col-4">
                      <div class="input-group">
                        <span class="input-group-text"  style=" background:rgb(29, 145, 195); color: aliceblue">Costo de Adquisicion</span>
                           <input type="text" id="costoAdqui" name="costoAdqui" class="form-control text-right" value="{{ $inventario->costo_adquisicion}}"
                  ...
                  <br>
                    ...
                    <div class="col-4">
                      ...
                      <input type="text" id="costoVenta" name="costoVenta" class="form-control text-right"  value="{{ $inventario->precio_venta}}"
                    ...
                    <div class="col-4">
                      <div class="input-group">
                        <span class="input-group-text"  style=" background:rgb(29, 145, 195); color: aliceblue">Precio Venta Unitario</span>
                           <input type="text" id="costoUni" name="costoUni" class="form-control text-right"  value="{{ $inventario->precio_venta_unitario}}"
                               required  onkeypress="return ((event.charCode >= 48 && event.charCode <= 57) || (event.charCode == 44) || (event.charCode == 46) || (event.charCode == 35) || (event.charCode == 47) || (event.charCode == 45) || (event.charCode == 124) || (event.charCode == 42))">
                               <span class="input-group-text" id="basic-addon1" >Bs.</span>
                      </div>
                       <span id="estadoCostoA"></span>
                ...
                <textarea class="embed-responsive form-control " style="resize: none;padding-left: 20px;padding-top: 20px" name="nota" id="nota" cols="140" rows="4">
                {{$inventario->detalle}}
                </textarea>
                <br>    
                <div class="form-group">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <a href="/inventarios/almacen/{{$id_almacen}}" class="btn btn-danger my-2 my-sm-0">Cancelar</a>
